...
import com.example.sadokey.tourism_guide.Classes.Places;
...
public class PlacesFragment extends Fragment
{
    ...
    private DatabaseReference myPlacesDatabase;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        myPlacesDatabase =myDatabase.child("places");
        myLikeDatabase=myDatabase.child("Likes");
        myUserDatabase=myDatabase.child("Users");
        myAuth=FirebaseAuth.getInstance();

        newsRecyclerView =(RecyclerView)v.findViewById(R.id.recycleView_Places);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Places,postViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Places, postViewHolder>
                (Places.class,R.layout.list_places,postViewHolder.class, myPlacesDatabase) {
            @Override
            protected void populateViewHolder(postViewHolder viewHolder, Places model, int position)
            {
    ...
    private static class  postViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public postViewHolder(View itemView) {
            ...
            txt_like_counter=(TextView)myView.findViewById(R.id.txt_Place_likecounter);


            myLikeDatabase= FirebaseDatabase.getInstance().getReference().child("PlacesLikes");
        ...
        {
            TextView txt_title=(TextView)myView.findViewById(R.id.txt_placename);
            txt_title.setText(Title);
        }

        void setDesc(String Desc)
        {
            TextView txt_Desc=(TextView)myView.findViewById(R.id.txt_PlacesDetails);
            txt_Desc.setText(Desc);
        }

        void setImg(String uriImg)
        {
            ImageView imgview=(ImageView)myView.findViewById(R.id.place_imageview);
